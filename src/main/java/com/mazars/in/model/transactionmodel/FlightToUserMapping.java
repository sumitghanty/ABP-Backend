...
@Table(name="tbl_flight_user_mapping")
public class FlightToUserMapping implements Serializable{
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name="flight_user_mapping_id")
	private int flightUserMappingId;
	...
	public int getFlightUserMappingId() {
		return flightUserMappingId;
	}
	public void setFlightUserMappingId(int flightUserMappingId) {
		this.flightUserMappingId = flightUserMappingId;
	}
